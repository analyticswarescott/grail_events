...
hideCalendarDate={true}
    ...
    render() {
        ...
        <Drawer
            ...
            width={260}
            open={isOpen}
        > <div className="sidebar-header" style={{paddingBottom: 55}}> <img height={62} width={62}  alt="download" src="/grail.png" /> Event Viewer</div>
     ...
     {/*       <div className="views">
            ...
            <div className="views" >
                <Menu>
                    <Link to={{pathname: "/overview", query: query}}><MenuItem primaryText="Timeline" leftIcon={<Dashboard className="icon"/>} /></Link>
