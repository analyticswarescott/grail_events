...
export function timeline()  {
        ...
        var hover = function () {},
            ...
            labelMargin = 0,
            ending = 0,
            margin = {left: 88, right:30, top: 30, bottom:30},
            stacked = false,
            rotateTicks = false,
        ...
        function timeline (gParent) {
           ...
           // console.log(beginning)
            ...
            g.each(function(d, i) {
                ...
                d.forEach( function(datum, index){
                    ...
                    g.selectAll("svg").data(data).enter()
                        ...
                        .attr("cx", getXPos)
                       // .attr("r",  d.color == 'green' ? 1 : itemHeight / 5)
            ...
            function getXPos(d, i) {
                ...
                var xpos = margin.left + (d.starting_time - beginning) * scaleFactor;
                return xpos;
            }
